<x-layoutadmin>
    ...
    <div class="p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <a href="/detail_pemesanan" class="w-full h-72 bg-white border border-black shadow-lg rounded-md overflow-hidden transition-transform transform hover:scale-105 cursor-pointer block">
