...
<div class="container mx-auto mb-10 mt-10 px-4">
  ...
  <div class="mt-8" id="camera">
    <div class="bg-gray-200 dark:bg-gray-700 rounded-full px-4 py-2 text-center shadow">
      <h3 class="text-gray-800 dark:text-gray-100 text-lg font-bold">Camera</h3>
    </div>
  ...
  <div class="mt-8" id="gimbal"> 
    <div class="bg-gray-200 dark:bg-gray-700 rounded-full px-4 py-2 text-center shadow">
      <h3 class="text-gray-800 dark:text-gray-100 text-lg font-bold">Gimbal</h3>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mt-6">
      <!-- Gimbal Produk Card -->
  ...
  <div class="mt-8" id="lensa">
    <div class="bg-gray-200 dark:bg-gray-700 rounded-full px-4 py-2 text-center shadow">
      <h3 class="text-gray-800 dark:text-gray-100 text-lg font-bold">Lensa</h3>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mt-6">
      <!-- Lensa Produk Card -->
  ...
  <div class="mt-8" id="tripod">
    <div class="bg-gray-200 dark:bg-gray-700 rounded-full px-4 py-2 text-center shadow">
      <h3 class="text-gray-800 dark:text-gray-100 text-lg font-bold">Tripod</h3>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mt-6">
      <!-- Tripod Produk Card -->
